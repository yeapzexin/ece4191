...
#define Timer_3_UsingHWEnable              1u
#define Timer_3_EnableTriggerMode          0u
#define Timer_3_InterruptOnCaptureCount    1u
...
#define Timer_3_INIT_CAPTURE_MODE       ((uint8)((uint8)2u << Timer_3_CTRL_CAP_MODE_SHIFT))
#define Timer_3_INIT_TRIGGER_MODE       ((uint8)((uint8)0u << Timer_3_CTRL_TRIG_MODE_SHIFT))
    ...
    #define Timer_3_INIT_INTERRUPT_MODE (((uint8)((uint8)0u << Timer_3_STATUS_TC_INT_MASK_SHIFT)) | \
                                                  ((uint8)((uint8)1 << Timer_3_STATUS_CAPTURE_INT_MASK_SHIFT)))
#else
    #define Timer_3_INIT_INTERRUPT_MODE (((uint8)((uint8)0u << Timer_3_STATUS_TC_INT_MASK_SHIFT)) | \
                                                 ((uint8)((uint8)1 << Timer_3_STATUS_CAPTURE_INT_MASK_SHIFT)) | \
